const Content = ({propsContent}) => {
    ...
    return (
        ...
        <div className="bg-black text-gray-50 items-center text-center">
            ...
            <div className="flex flex-col justify-center gap-3 items-center rounded overflow-hidden shadow-lg bg-red-600">
                {propsContent.map((data,index)=>(
                    <div key={index} className="bg-[#36BA98] p-5 rounded-lg">
                        ...
                        <h1 className="text-2xl text-slate-950 font-bold text-center">{data.price}</h1>

const Content = ({propsContent}) => {
    ...
    return (
        ...
        <div className="bg-black text-gray-50 items-center text-center h-9 md:text-2xl">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-3 items-center rounded overflow-hidden shadow-lg bg-[#7FA1C3]">
                {propsContent.map((data,index)=>(
                    <div key={index} className="bg-[#EDDFE0] p-3 rounded-lg md:p-2">
                        ...
                        <img src={data.image} alt="image" className="h-64 md:h-28" />
